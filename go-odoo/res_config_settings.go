...
type ResConfigSettings struct {
	...
	GroupApplicantCvDisplay                     *Bool      `xmlrpc:"group_applicant_cv_display,omitempty"`
	...
	ModuleHrRecruitmentExtract                  *Bool      `xmlrpc:"module_hr_recruitment_extract,omitempty"`
